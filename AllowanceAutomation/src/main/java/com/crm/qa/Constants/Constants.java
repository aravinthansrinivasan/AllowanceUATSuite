...
public class Constants 
{
	...
	public static final long PAGE_LOAD_TIMEOUT = 3000;
	public static final long IMPLICIT_WAIT = 3000;
	...
	public static final String LOGIN_PAGE_TITLE = "Aravin Test Employee Allowance Form";
	public static final String HOME_PAGE_TITLE = "Allowance";
